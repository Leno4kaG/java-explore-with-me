...
public class EventPublicControllerTest {
    ...
    class GetEventsByPublic {
        @Test
        public void getEventsByPublic() throws Exception {
            ...
            mvc.perform(get("/events?text=0&" +
                            "categories=0&" +
                            "paid=true&" +
                            "rangeStart=2023-05-06 16:30:00&" +
                            "rangeEnd=2047-06-06 17:30:00&" +
                            "onlyAvailable=false&" +
                            "sort=EVENT_DATE&" +
                            "from=0&" +
                            "size=1000")
        ...
        @Test
        public void getEventsByPublicWithEmptyParameters() throws Exception {
            when(eventService.getEventsByPublic(any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
                    .thenReturn(List.of(eventShortDto1, eventShortDto2));
        ...
        @Test
        public void getEventsByPublicWhenRangeStartNoPattern() throws Exception {
            mvc.perform(get("/events?rangeStart=2023-04-06T16:30:00")
                            .characterEncoding(StandardCharsets.UTF_8)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON))
        ...
        @Test
        public void getEventsByPublicWhenRangeEndNoPattern() throws Exception {
            mvc.perform(get("/events?rangeEnd=2047-08-06T17:30:00")
                            .characterEncoding(StandardCharsets.UTF_8)
                            .contentType(MediaType.APPLICATION_JSON)
                            .accept(MediaType.APPLICATION_JSON))
                    .andExpect(status().isBadRequest());
        ...
        @Test
        public void getEventsByPublicWhenFromIsNegative() throws Exception {
        ...
        @Test
        public void getEventsByPublicWhenSizeIsZero() throws Exception {
        ...
        @Test
        public void getEventsByPublicWhenSizeIsNegative() throws Exception {
    ...
    class GetEventByPublic {
        @Test
        public void getEventByPublic() throws Exception {
