...
public class CompilationPublicControllerTest {
    ...
    @Test
    public void getAllParamDefaultAndPinnedIsNull() throws Exception {
        when(compilationService.getAll(any(), any())).thenReturn(List.of(compilationDto));
    ...
    @Test
    public void getAllWhenCompilationListEmpty() throws Exception {
    ...
    @Test
    public void getAllWhenFromIsNegative() throws Exception {
    ...
    @Test
    public void getAllWhenSizeIsZero() throws Exception {
    ...
    @Test
    public void getAllWhenSizeIsNegative() throws Exception {
