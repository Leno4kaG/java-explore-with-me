...
public class UserAdminControllerTest {
    ...
    class Create {
        ...
        @Test
        public void createWhenNameIsNull() throws Exception {
        ...
        @Test
        public void createWhenNameIsEmpty() throws Exception {
        ...
        @Test
        public void createWhenNameIsBlank() throws Exception {
            newUserRequest.setName(" ");
        ...
        @Test
        public void createWhenEmailIsNull() throws Exception {
        ...
        @Test
        public void createWhenEmailIsEmpty() throws Exception {
        ...
        @Test
        public void createWhenEmailIsBlank() throws Exception {
            newUserRequest.setEmail(" ");
        ...
        @Test
        public void createWhenEmailIsNotValid() throws Exception {
            newUserRequest.setEmail("yandex.ru");
    ...
    class GetUsers {
        ...
        @Test
        public void getUsersWhenIdsEmpty() throws Exception {
            when(userService.getUsers(ArgumentMatchers.any(), ArgumentMatchers.any()))
        ...
        @Test
        public void getUsersByDefault() throws Exception {
            when(userService.getUsers(ArgumentMatchers.any(), ArgumentMatchers.any()))
                    .thenReturn(List.of(userDto1, userDto2));
        ...
        @Test
        public void getUsersEmptyByDefault() throws Exception {
            when(userService.getUsers(ArgumentMatchers.any(), ArgumentMatchers.any()))
                    .thenReturn(List.of());
        ...
        @Test
        public void getUsersWhenIdIsNegative() throws Exception {
            when(userService.getUsers(ArgumentMatchers.any(), ArgumentMatchers.any()))
                    .thenReturn(List.of());
        ...
        @Test
        public void getUsersWhenFromIsNegative() throws Exception {
        ...
        @Test
        public void getUsersWhenSizeIsZero() throws Exception {
        ...
        @Test
        public void getUsersWhenSizeIsNegative() throws Exception {
